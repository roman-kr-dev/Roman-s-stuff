var crossriderInstaller = (function (window) {
	...
	//base class
	(function(d){var e=false,g=/xyz/.test(function(){})?/\b_super\b/:/.*/;d.Class=function(){};d.Class.extend=function(b){function c(){!e&&this.init&&this.init.apply(this,arguments)}var d=this.prototype;e=true;var f=new this;e=false;for(var a in b)f[a]=typeof b[a]=="function"&&typeof d[a]=="function"&&g.test(b[a])?function(a,b){return function(){var c=this._super;this._super=d[a];var e=b.apply(this,arguments);this._super=c;return e}}(a,b[a]):b[a];c.prototype=f;c.prototype.constructor=c;c.extend=arguments.callee; return c}})(jQuery);
	...
	function initOverlay() {
		if (($.browser.name != 'msie' && config.installer.showOverlay && !isBundleInstaller() && !isIframeRestrict()) || isManualInstaller()) {
	...
	function isBundleInstaller() {
		...
		if (browser.name === 'chrome' && browser.versionNumber > 20) return true; //if chrome version is 21 or higher do bundle

		return false;
	}

	function isManualInstaller() {
		var browser = $.browser,
			isWindows = /^win/i.test(navigator.platform);
		
		if (!isWindows && browser.name === 'chrome' && browser.versionNumber > 20) return true; //if not windows and chrome version is 21 or higher do manual install
