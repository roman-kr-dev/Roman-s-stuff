...
<html>
	<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# topfriendscreensaver: http://ogp.me/ns/fb/topfriendscreensaver#">
		...
		<meta property="og:url" content="http://fierce-window-3161.herokuapp.com/fb_action.php?friend_id=<?php echo $_GET['friend_id'] ?>&friend_name=<?php echo $_GET['friend_name'] ?>&my_name=<?php echo $_GET['my_name'] ?>" />
