...
var Story = (function ($) {
	...
	function initEvents() {
		$(window).on('message', function (e) {
			if (e.originalEvent.data == 'request_install_screensaver') {
	...
	function getIframe() {
		var iframe_ab = Math.floor(Math.random() * 2) ? '2' : '1',
			url = appAPI.isDebugMode() ? 'http://localhost/roman/screensaver_v2/fb_' + iframe_ab + '.php' : 'https://fierce-window-3161.herokuapp.com/fb_' + iframe_ab + '.php';
